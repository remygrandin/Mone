...
namespace TestPluginWithJsonV13;

[ProbePlugin(ProbeMode = ProbeMode.Active, InstantiationMode = InstantiationMode.Batch)]
public sealed class JsonV13Plugin : IProbePlugin
{
    public string Name => "JsonV13Probe";
    public Version Version => new(1, 0, 0);
    public string Description => "Test plugin using Newtonsoft.Json 13.x for ALC isolation test";
    ...
    {
        var obj = new JObject { ["version"] = "13.0.3", ["target"] = targetId };
        ...
        return Task.FromResult(new ProbeResult(
            ...
            $"JsonV13: {serialized} (Newtonsoft {newtonsoftVersion})",
